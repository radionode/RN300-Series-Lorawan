...
2.  Just click the plugin then the device tab. There you can see the Radionode RM320-BTH image, as shown in the image below.


  ![The Things Stack Payload Formatters Uplink Menu](images/thingerio/Thinger_Lora_7.png)

  There you can see the Radionode RM320-BTH image, as shown in the image below.
